...
/**
 * WebGenerateTests is a CGI program to generate tests from a specification.
 * 
 * @author Anthony J H Simons
 * @version Broker@Cloud 0.1
 */
public class WebGenerateTests {
	...
	public static void main(String[] args) {
		...
		try {
		    ...
		    int depth = Integer.parseInt(form.get("depth"));
		    boolean multi = Boolean.parseBoolean(form.get("multi"));
			...
			TestSuite testSuite = service.generateTestSuite(depth, multi);
