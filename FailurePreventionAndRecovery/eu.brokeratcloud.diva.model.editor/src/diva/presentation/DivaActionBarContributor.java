 ...
 * @generated
 */
public class DivaActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	/**
	...
	protected IAction showPropertiesViewAction = new Action(
			DiVA_visitorEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	...
	protected IAction refreshViewerAction = new Action(
			DiVA_visitorEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				DiVA_visitorEditorPlugin.INSTANCE.getString("_UI_DivaEditor_menu"), "divaMenuID");
		...
		createChildMenuManager = new MenuManager(
				DiVA_visitorEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(
				DiVA_visitorEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
