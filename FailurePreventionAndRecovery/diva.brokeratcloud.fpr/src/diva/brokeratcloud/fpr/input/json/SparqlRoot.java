...
public class SparqlRoot {

	public static SparqlRoot INSTANCE = new SparqlRoot();

	public String prefixes = "prefix sp: <http://www.broker-cloud.eu/service-descriptions/CAS/service-provider#> \n"
			...
			+ "prefix usdl-core-cb: <http://www.linked-usdl.org/ns/usdl-core-cb#>"
			+ "prefix usdl-sla-cb: <http://www.linked-usdl.org/ns/usdl-sla-cb#>"
			+ "prefix usdl-business-roles: <http://www.linked-usdl.org/ns/usdl-business-roles#>";

	public String defaultOutput = "Text";

	public String server = "http://localhost:3030/ds/query";
	...
	public String query(String query, String output) {
		...
		try {
			URI uri = new URIBuilder(server).addParameter("query", q).addParameter("output", output).build();
