...
public class QueryAttempt {
	public void testQuery() throws URISyntaxException, ClientProtocolException, IOException {
		String query = "prefix sp: <http://www.broker-cloud.eu/service-descriptions/CAS/service-provider#> \n"
		...
		URI uri = new URIBuilder("http://netserv.seerc.org:3030/BrokerAtCloud/query").addParameter("query", query)
