...
/**
 * 
 * A Configuration Pool mains a set of configurations under a particular
 * context. It means that whenever the context is changed, a new pool should be
 * created.
 * 
...
public class ConfigurationsPool {
	...
	/**
	 * Could be "false" (rejected), "true" (accepted), or "null" (no response on
	 * this recomm yet)
	 * 
	 * @param id
	 * @return
