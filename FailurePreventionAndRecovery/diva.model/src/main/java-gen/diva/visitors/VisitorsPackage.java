...
public interface VisitorsPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link diva.visitors.Visitable
	...
	/**
	 * The meta object id for the '{@link diva.visitors.Visitor <em>Visitor</em>
	...
	/**
	 * The meta object id for the '{@link diva.visitors.impl.TopDownVisitorImpl
	 * <em>Top Down Visitor</em>}' class. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The number of structural features of the '<em>Top Down Visitor</em>'
	 * class. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * Returns the meta object for class '{@link diva.visitors.Visitable
	...
	/**
	 * Returns the meta object for class '{@link diva.visitors.Visitor
	...
	/**
	 * Returns the meta object for class '{@link diva.visitors.TopDownVisitor
	 * <em>Top Down Visitor</em>}'. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link diva.visitors.Visitable
		 * <em>Visitable</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc
		 * -->
		 * 
		 * @see diva.visitors.Visitable
		...
		/**
		 * The meta object literal for the '{@link diva.visitors.Visitor
		 ...
		 * {@link diva.visitors.impl.TopDownVisitorImpl
		 * <em>Top Down Visitor</em>}' class. <!-- begin-user-doc --> <!--
		 * end-user-doc -->
		 * 
		 * @see diva.visitors.impl.TopDownVisitorImpl
