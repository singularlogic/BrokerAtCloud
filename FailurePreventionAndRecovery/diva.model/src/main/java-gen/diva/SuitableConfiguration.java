...
public interface SuitableConfiguration extends Visitable {
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Score</em>' attribute isn't clear, there
	...
	/**
	 * Sets the value of the '{@link diva.SuitableConfiguration#getScore
	 * <em>Score</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Score</em>' attribute.
	 * @see #getScore()
	 * @generated
	 */
	 ...
	 * 
	 * @model annotation=
	 *        "http://www.eclipse.org/emf/2002/GenModel body='return visitor.visitSuitableConfiguration(this, context);'"
	 *        annotation=
