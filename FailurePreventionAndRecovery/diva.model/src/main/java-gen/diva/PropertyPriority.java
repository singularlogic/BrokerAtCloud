...
public interface PropertyPriority extends DiVAModelElement {
	...
	/**
	 * Sets the value of the '{@link diva.PropertyPriority#getProperty
	...
	/**
	 * Sets the value of the '{@link diva.PropertyPriority#getPriority
	 ...
	 * 
	 * @model annotation=
	 *        "http://www.eclipse.org/emf/2002/GenModel body='return visitor.visitPropertyPriority(this, context);'"
	 *        annotation=
