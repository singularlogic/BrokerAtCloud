...
public class DivaSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case DivaPackage.INVARIANT: {
			...
			if (result == null)
				result = caseConstraint(invariant);
			if (result == null)
				result = caseNamedElement(invariant);
			if (result == null)
				result = caseDiVAModelElement(invariant);
			if (result == null)
				result = caseVisitable(invariant);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.VARIABLE: {
			...
			if (result == null)
				result = caseDiVAModelElement(variable);
			if (result == null)
		...
		case DivaPackage.ENUM_VARIABLE: {
			...
			if (result == null)
				result = caseVariable(enumVariable);
			if (result == null)
				result = caseNamedElement(enumVariable);
			if (result == null)
				result = caseDiVAModelElement(enumVariable);
			if (result == null)
				result = caseVisitable(enumVariable);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.BOOLEAN_VARIABLE: {
			...
			if (result == null)
				result = caseCEPable(booleanVariable);
			if (result == null)
				result = caseNamedElement(booleanVariable);
			if (result == null)
				result = caseDiVAModelElement(booleanVariable);
			if (result == null)
				result = caseVisitable(booleanVariable);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.TERM: {
			...
			if (result == null)
				result = caseDiVAModelElement(term);
			if (result == null)
				result = caseVisitable(term);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.AND_TERM: {
			...
			if (result == null)
				result = caseNaryTerm(andTerm);
			if (result == null)
				result = caseTerm(andTerm);
			if (result == null)
				result = caseDiVAModelElement(andTerm);
			if (result == null)
				result = caseVisitable(andTerm);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.OR_TERM: {
			...
			if (result == null)
				result = caseNaryTerm(orTerm);
			if (result == null)
				result = caseTerm(orTerm);
			if (result == null)
				result = caseDiVAModelElement(orTerm);
			if (result == null)
				result = caseVisitable(orTerm);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.NOT_TERM: {
			...
			if (result == null)
				result = caseTerm(notTerm);
			if (result == null)
				result = caseDiVAModelElement(notTerm);
			if (result == null)
				result = caseVisitable(notTerm);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.NARY_TERM: {
			...
			if (result == null)
				result = caseTerm(naryTerm);
			if (result == null)
				result = caseDiVAModelElement(naryTerm);
			if (result == null)
				result = caseVisitable(naryTerm);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.VARIANT_TERM: {
			...
			if (result == null)
				result = caseTerm(variantTerm);
			if (result == null)
				result = caseDiVAModelElement(variantTerm);
			if (result == null)
				result = caseVisitable(variantTerm);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.VARIABLE_TERM: {
			...
			if (result == null)
				result = caseTerm(variableTerm);
			if (result == null)
				result = caseDiVAModelElement(variableTerm);
			if (result == null)
				result = caseVisitable(variableTerm);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.ENUM_TERM: {
			...
			if (result == null)
				result = caseVariableTerm(enumTerm);
			if (result == null)
				result = caseTerm(enumTerm);
			if (result == null)
				result = caseDiVAModelElement(enumTerm);
			if (result == null)
				result = caseVisitable(enumTerm);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.BOOLEAN_TERM: {
			...
			if (result == null)
				result = caseVariableTerm(booleanTerm);
			if (result == null)
				result = caseTerm(booleanTerm);
			if (result == null)
				result = caseDiVAModelElement(booleanTerm);
			if (result == null)
				result = caseVisitable(booleanTerm);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.RULE: {
			...
			if (result == null)
				result = caseDiVAModelElement(rule);
			if (result == null)
				result = caseVisitable(rule);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.ENUM_LITERAL: {
			...
			if (result == null)
				result = caseCEPable(enumLiteral);
			if (result == null)
				result = caseDiVAModelElement(enumLiteral);
			if (result == null)
				result = caseVisitable(enumLiteral);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.NAMED_ELEMENT: {
			...
			if (result == null)
				result = caseDiVAModelElement(namedElement);
			if (result == null)
				result = caseVisitable(namedElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.CONSTRAINT: {
			...
			if (result == null)
				result = caseDiVAModelElement(constraint);
			if (result == null)
				result = caseVisitable(constraint);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.VARIANT: {
			...
			if (result == null)
				result = caseDiVAModelElement(variant);
			if (result == null)
				result = caseVisitable(variant);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.DIMENSION: {
			...
			if (result == null)
				result = caseDiVAModelElement(dimension);
			if (result == null)
				result = caseVisitable(dimension);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.EXPRESSION: {
			...
			if (result == null)
				result = caseDiVAModelElement(expression);
			if (result == null)
				result = caseVisitable(expression);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.CONTEXT_EXPRESSION: {
			...
			if (result == null)
				result = caseExpression(contextExpression);
			if (result == null)
				result = caseDiVAModelElement(contextExpression);
			if (result == null)
				result = caseVisitable(contextExpression);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.VARIANT_EXPRESSION: {
			...
			if (result == null)
				result = caseExpression(variantExpression);
			if (result == null)
				result = caseDiVAModelElement(variantExpression);
			if (result == null)
				result = caseVisitable(variantExpression);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.PRIORITY_RULE: {
			...
			if (result == null)
				result = caseRule(priorityRule);
			if (result == null)
				result = caseNamedElement(priorityRule);
			if (result == null)
				result = caseDiVAModelElement(priorityRule);
			if (result == null)
				result = caseVisitable(priorityRule);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.PROPERTY: {
			...
			if (result == null)
				result = caseDiVAModelElement(property);
			if (result == null)
				result = caseVisitable(property);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.PROPERTY_LITERAL: {
			...
			if (result == null)
				result = caseNamedElement(propertyLiteral);
			if (result == null)
				result = caseDiVAModelElement(propertyLiteral);
			if (result == null)
				result = caseVisitable(propertyLiteral);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.PROPERTY_VALUE: {
			...
			if (result == null)
				result = caseDiVAModelElement(propertyValue);
			if (result == null)
				result = caseVisitable(propertyValue);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.PROPERTY_PRIORITY: {
			...
			if (result == null)
				result = caseDiVAModelElement(propertyPriority);
			if (result == null)
				result = caseVisitable(propertyPriority);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.MULTIPLICITY_CONSTRAINT: {
			...
			if (result == null)
				result = caseConstraint(multiplicityConstraint);
			if (result == null)
				result = caseNamedElement(multiplicityConstraint);
			if (result == null)
				result = caseDiVAModelElement(multiplicityConstraint);
			if (result == null)
				result = caseVisitable(multiplicityConstraint);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.ANNOTATION: {
			...
			if (result == null)
				result = caseVisitable(annotation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.DI_VA_MODEL_ELEMENT: {
			...
			if (result == null)
				result = caseVisitable(diVAModelElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.SIMULATION_MODEL: {
			...
			if (result == null)
				result = caseDiVAModelElement(simulationModel);
			if (result == null)
				result = caseVisitable(simulationModel);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.CONTEXT: {
			...
			if (result == null)
				result = caseDiVAModelElement(context);
			if (result == null)
				result = caseVisitable(context);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.CONFIGURATION: {
			...
			if (result == null)
				result = caseScoredElement(configuration);
			if (result == null)
				result = caseDiVAModelElement(configuration);
			if (result == null)
				result = caseVisitable(configuration);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.CONFIG_VARIANT: {
			...
			if (result == null)
				result = caseScoredElement(configVariant);
			if (result == null)
				result = caseDiVAModelElement(configVariant);
			if (result == null)
				result = caseVisitable(configVariant);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.SCENARIO: {
			...
			if (result == null)
				result = caseDiVAModelElement(scenario);
			if (result == null)
				result = caseVisitable(scenario);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.SCORED_ELEMENT: {
			...
			if (result == null)
				result = caseDiVAModelElement(scoredElement);
			if (result == null)
				result = caseVisitable(scoredElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.SCORE: {
			...
			if (result == null)
				result = caseDiVAModelElement(score);
			if (result == null)
				result = caseVisitable(score);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.PRIORITY: {
			...
			if (result == null)
				result = caseDiVAModelElement(priority);
			if (result == null)
				result = caseVisitable(priority);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.VARIABLE_VALUE: {
			...
			if (result == null)
				result = caseDiVAModelElement(variableValue);
			if (result == null)
				result = caseVisitable(variableValue);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.BOOL_VARIABLE_VALUE: {
			...
			if (result == null)
				result = caseVariableValue(boolVariableValue);
			if (result == null)
				result = caseDiVAModelElement(boolVariableValue);
			if (result == null)
				result = caseVisitable(boolVariableValue);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.ENUM_VARIABLE_VALUE: {
			...
			if (result == null)
				result = caseVariableValue(enumVariableValue);
			if (result == null)
				result = caseDiVAModelElement(enumVariableValue);
			if (result == null)
				result = caseVisitable(enumVariableValue);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.CONFIGURATION_MODEL: {
			...
			if (result == null)
				result = caseVisitable(configurationModel);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.SUITABLE_CONFIGURATION: {
			...
			if (result == null)
				result = caseVisitable(suitableConfiguration);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DivaPackage.CONTEXT_MODEL: {
			...
			if (result == null)
				result = caseVisitable(contextModel);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * <em>Variability Model</em>'. <!-- begin-user-doc --> This implementation
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Invariant</em>'. <!-- begin-user-doc --> This implementation returns
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Enum Variable</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Boolean Variable</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>And Term</em>'. <!-- begin-user-doc --> This implementation returns
	 * null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Or Term</em>'. <!-- begin-user-doc --> This implementation returns
	 * null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Not Term</em>'. <!-- begin-user-doc --> This implementation returns
	 * null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Nary Term</em>'. <!-- begin-user-doc --> This implementation returns
	 * null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Variant Term</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Variable Term</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Enum Term</em>'. <!-- begin-user-doc --> This implementation returns
	 * null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Boolean Term</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Enum Literal</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Context Expression</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Variant Expression</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Priority Rule</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Property Literal</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Property Value</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Property Priority</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Multiplicity Constraint</em>'. <!-- begin-user-doc --> This
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Di VA Model Element</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate
	 * the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Simulation Model</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Config Variant</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Scored Element</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Score</em>'. <!-- begin-user-doc --> This implementation returns
	 * null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Priority</em>'. <!-- begin-user-doc --> This implementation returns
	 * null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Bool Variable Value</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate
	 * the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Enum Variable Value</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate
	 * the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Configuration Model</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate
	 * the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Suitable Configuration</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate
	 * the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Context Model</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>CE Pable</em>'. <!-- begin-user-doc --> This implementation returns
	 * null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
