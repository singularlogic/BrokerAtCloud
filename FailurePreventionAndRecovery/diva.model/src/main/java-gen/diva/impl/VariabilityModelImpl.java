 ...
 * <em><b>Variability Model</b></em>'. <!-- end-user-doc -->
 * <p>
 ...
 * <li>{@link diva.impl.VariabilityModelImpl#getDimension <em>Dimension</em>}
 * </li>
 * <li>{@link diva.impl.VariabilityModelImpl#getRule <em>Rule</em>}</li>
 * <li>{@link diva.impl.VariabilityModelImpl#getConstraint <em>Constraint</em>}
 * </li>
 * <li>{@link diva.impl.VariabilityModelImpl#getSimulation <em>Simulation</em>}
 * </li>
 * </ul>
 * </p>
 *
...
public class VariabilityModelImpl extends EObjectImpl implements VariabilityModel {
	...
	/**
	 * The cached value of the '{@link #getSimulation() <em>Simulation</em>}'
	...
	public EList<Variable> getContext() {
		if (context == null) {
			context = new EObjectContainmentEList<Variable>(Variable.class, this,
					DivaPackage.VARIABILITY_MODEL__CONTEXT);
		}
		return context;
	}
	...
	public EList<Property> getProperty() {
		if (property == null) {
			property = new EObjectContainmentEList<Property>(Property.class, this,
					DivaPackage.VARIABILITY_MODEL__PROPERTY);
		}
		return property;
	}
	...
	public EList<Dimension> getDimension() {
		if (dimension == null) {
			dimension = new EObjectContainmentEList<Dimension>(Dimension.class, this,
					DivaPackage.VARIABILITY_MODEL__DIMENSION);
		}
		return dimension;
	}
	...
	public EList<Constraint> getConstraint() {
		if (constraint == null) {
			constraint = new EObjectContainmentEList<Constraint>(Constraint.class, this,
					DivaPackage.VARIABILITY_MODEL__CONSTRAINT);
		}
		return constraint;
	}
	...
	public NotificationChain basicSetSimulation(SimulationModel newSimulation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DivaPackage.VARIABILITY_MODEL__SIMULATION, oldSimulation, newSimulation);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setSimulation(SimulationModel newSimulation) {
		if (newSimulation != simulation) {
			...
			if (simulation != null)
				msgs = ((InternalEObject) simulation).eInverseRemove(this, DivaPackage.SIMULATION_MODEL__MODEL,
						SimulationModel.class, msgs);
			if (newSimulation != null)
				msgs = ((InternalEObject) newSimulation).eInverseAdd(this, DivaPackage.SIMULATION_MODEL__MODEL,
						SimulationModel.class, msgs);
			msgs = basicSetSimulation(newSimulation, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DivaPackage.VARIABILITY_MODEL__SIMULATION,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case DivaPackage.VARIABILITY_MODEL__SIMULATION:
			if (simulation != null)
				msgs = ((InternalEObject) simulation).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DivaPackage.VARIABILITY_MODEL__SIMULATION, null, msgs);
