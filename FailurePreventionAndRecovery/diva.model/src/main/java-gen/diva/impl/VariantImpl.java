 ...
 * <li>{@link diva.impl.VariantImpl#getPropertyValue <em>Property Value</em>}
 * </li>
...
public class VariantImpl extends NamedElementImpl implements Variant {
	/**
	 * The cached value of the '{@link #getPropertyValue()
	 * <em>Property Value</em>}' containment reference list. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getAvailable() <em>Available</em>}'
	 * containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getAvailable()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getRequired() <em>Required</em>}'
	 * containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getRequired()
	 * @generated
	...
	public Dimension getType() {
		if (eContainerFeatureID() != DivaPackage.VARIANT__TYPE)
			return null;
	...
	public void setType(Dimension newType) {
		if (newType != eInternalContainer()
				|| (eContainerFeatureID() != DivaPackage.VARIANT__TYPE && newType != null)) {
			...
			if (newType != null)
				msgs = ((InternalEObject) newType).eInverseAdd(this, DivaPackage.DIMENSION__VARIANT, Dimension.class,
						msgs);
	...
	public EList<PropertyValue> getPropertyValue() {
		if (propertyValue == null) {
			propertyValue = new EObjectContainmentEList<PropertyValue>(PropertyValue.class, this,
					DivaPackage.VARIANT__PROPERTY_VALUE);
		}
	...
	public NotificationChain basicSetDependency(VariantExpression newDependency, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DivaPackage.VARIANT__DEPENDENCY, oldDependency, newDependency);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newDependency != dependency) {
			...
			if (dependency != null)
				msgs = ((InternalEObject) dependency).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DivaPackage.VARIANT__DEPENDENCY, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DivaPackage.VARIANT__DEPENDENCY, newDependency,
					newDependency));
	}
	...
	public NotificationChain basicSetAvailable(ContextExpression newAvailable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DivaPackage.VARIANT__AVAILABLE, oldAvailable, newAvailable);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setAvailable(ContextExpression newAvailable) {
		if (newAvailable != available) {
			NotificationChain msgs = null;
			if (available != null)
				msgs = ((InternalEObject) available).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DivaPackage.VARIANT__AVAILABLE, null, msgs);
			if (newAvailable != null)
				msgs = ((InternalEObject) newAvailable).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - DivaPackage.VARIANT__AVAILABLE, null, msgs);
			msgs = basicSetAvailable(newAvailable, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DivaPackage.VARIANT__AVAILABLE, newAvailable,
					newAvailable));
	}
	...
	public NotificationChain basicSetRequired(ContextExpression newRequired, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DivaPackage.VARIANT__REQUIRED, oldRequired, newRequired);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newRequired != required) {
			...
			if (required != null)
				msgs = ((InternalEObject) required).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DivaPackage.VARIANT__REQUIRED, null, msgs);
			if (newRequired != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DivaPackage.VARIANT__REQUIRED, newRequired,
					newRequired));
	}
