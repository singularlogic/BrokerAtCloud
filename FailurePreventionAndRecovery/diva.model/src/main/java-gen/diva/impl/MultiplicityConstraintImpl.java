 ...
 * <em><b>Multiplicity Constraint</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link diva.impl.MultiplicityConstraintImpl#getAvailable
 * <em>Available</em>}</li>
...
public class MultiplicityConstraintImpl extends ConstraintImpl implements MultiplicityConstraint {
	...
	public NotificationChain basicSetAvailable(ContextExpression newAvailable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DivaPackage.MULTIPLICITY_CONSTRAINT__AVAILABLE, oldAvailable, newAvailable);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newAvailable != available) {
			...
			if (available != null)
				msgs = ((InternalEObject) available).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DivaPackage.MULTIPLICITY_CONSTRAINT__AVAILABLE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DivaPackage.MULTIPLICITY_CONSTRAINT__AVAILABLE,
	...
	public void setUpper(int newUpper) {
		...
		upper = newUpper;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DivaPackage.MULTIPLICITY_CONSTRAINT__UPPER, oldUpper,
					upper));
	}
	...
	public void setLower(int newLower) {
		...
		lower = newLower;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DivaPackage.MULTIPLICITY_CONSTRAINT__LOWER, oldLower,
					lower));
	}
