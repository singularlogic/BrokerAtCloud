...
public interface Property extends NamedElement {
	...
	/**
	 * Sets the value of the '{@link diva.Property#getDirection
	 ...
	 * list. The list contents are of type {@link diva.PropertyLiteral}. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Literal</em>' containment reference list isn't
	 ...
	 * 
	 * @model annotation=
	 *        "http://www.eclipse.org/emf/2002/GenModel body='return visitor.visitProperty(this, context);'"
	 *        annotation=
