...
public interface Score extends DiVAModelElement {
	...
	/**
	 * Sets the value of the '{@link diva.Score#getScore <em>Score</em>}'
	...
	/**
	 * Sets the value of the '{@link diva.Score#getProperty <em>Property</em>}'
	 ...
	 * 
	 * @model annotation=
	 *        "http://www.eclipse.org/emf/2002/GenModel body='return visitor.visitScore(this, context);'"
	 *        annotation=
