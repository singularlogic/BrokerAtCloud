...
public interface ScoredElement extends DiVAModelElement {
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Total Score</em>' attribute isn't clear, there
	...
	/**
	 * Sets the value of the '{@link diva.ScoredElement#getTotalScore
	 * <em>Total Score</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Total Score</em>' attribute.
	 * @see #getTotalScore()
	 * @generated
	 */
	 ...
	 * list. The list contents are of type {@link diva.Score}. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Score</em>' containment reference list isn't
