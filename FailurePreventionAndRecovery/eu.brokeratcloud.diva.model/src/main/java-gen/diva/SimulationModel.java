...
public interface SimulationModel extends DiVAModelElement {
	 ...
	 * list. The list contents are of type {@link diva.Scenario}. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Scenario</em>' containment reference list
	...
	/**
	 * Returns the value of the '<em><b>Model</b></em>' container reference. It
	...
	/**
	 * Sets the value of the '{@link diva.SimulationModel#getModel
	 ...
	 * 
	 * @model annotation=
	 *        "http://www.eclipse.org/emf/2002/GenModel body='return visitor.visitSimulationModel(this, context);'"
	 *        annotation=
