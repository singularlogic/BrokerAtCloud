...
public interface TopDownVisitor<ContextType, ResultType> extends Visitor<ContextType, ResultType> {
	 ...
	 *        annotation=
	 *        "http://www.eclipse.org/emf/2002/GenModel body='for (int i=0; i<node.getAnnotation().size(); i++) { ((diva.Annotation)node.getAnnotation().get(i)).accept(this, context); }\nif (node.getExpression() != null) { node.getExpression().accept(this, context); }\nreturn null;\n'"
	 * @generated
	 */
	 ...
	 *        annotation=
	 *        "http://www.eclipse.org/emf/2002/GenModel body='for (int i=0; i<node.getTerm().size(); i++) { ((diva.Term)node.getTerm().get(i)).accept(this, context); }\nfor (int i=0; i<node.getAnnotation().size(); i++) { ((diva.Annotation)node.getAnnotation().get(i)).accept(this, context); }\nreturn null;\n'"
	 * @generated
	 */
	 ...
	 *        "kermeta body='do\nif node.term != void then node.term.accept(self, context) end\nnode.annotation.each{ e | e.accept(self, context) }\nend' isAbstract='false'"
	 *        annotation=
	 *        "http://www.eclipse.org/emf/2002/GenModel body='if (node.getTerm() != null) { node.getTerm().accept(this, context); }\nfor (int i=0; i<node.getAnnotation().size(); i++) { ((diva.Annotation)node.getAnnotation().get(i)).accept(this, context); }\nreturn null;\n'"
	 * @generated
	 */
	 ...
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @model annotation="kermeta body='do\nend' isAbstract='false'" annotation=
	 *        "http://www.eclipse.org/emf/2002/GenModel body='return null;\n'"
	 * @generated
	 */
	 ...
	 *        annotation=
	 *        "http://www.eclipse.org/emf/2002/GenModel body='for (int i=0; i<node.getScore().size(); i++) { ((diva.Score)node.getScore().get(i)).accept(this, context); }\nfor (int i=0; i<node.getAnnotation().size(); i++) { ((diva.Annotation)node.getAnnotation().get(i)).accept(this, context); }\nfor (int i=0; i<node.getVariant().size(); i++) { ((diva.ConfigVariant)node.getVariant().get(i)).accept(this, context); }\nreturn null;\n'"
	 * @generated
	 */
	 ...
	 *        annotation=
	 *        "http://www.eclipse.org/emf/2002/GenModel body='for (int i=0; i<node.getConfigurations().size(); i++) { ((diva.SuitableConfiguration)node.getConfigurations().get(i)).accept(this, context); }\nreturn null;\n'"
	 * @generated
	 */
	 ...
	 *        "kermeta body='do\nnode.variant.each{ e | e.accept(self, context) }\nend' isAbstract='false'"
	 *        annotation=
	 *        "http://www.eclipse.org/emf/2002/GenModel body='for (int i=0; i<node.getVariant().size(); i++) { ((diva.ConfigVariant)node.getVariant().get(i)).accept(this, context); }\nreturn null;\n'"
	 * @generated
	 */
	 ...
	 *        "kermeta body='do\nnode.variable.each{ e | e.accept(self, context) }\nend' isAbstract='false'"
	 *        annotation=
	 *        "http://www.eclipse.org/emf/2002/GenModel body='for (int i=0; i<node.getVariable().size(); i++) { ((diva.VariableValue)node.getVariable().get(i)).accept(this, context); }\nreturn null;\n'"
	 * @generated
	 */
