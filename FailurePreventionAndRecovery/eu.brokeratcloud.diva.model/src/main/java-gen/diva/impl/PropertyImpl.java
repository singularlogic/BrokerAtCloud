...
public class PropertyImpl extends NamedElementImpl implements Property {
	...
	public void setDirection(int newDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DivaPackage.PROPERTY__DIRECTION, oldDirection,
					direction));
	}
	...
	public EList<PropertyLiteral> getLiteral() {
		if (literal == null) {
			literal = new EObjectContainmentEList<PropertyLiteral>(PropertyLiteral.class, this,
					DivaPackage.PROPERTY__LITERAL);
		}
		return literal;
	}
