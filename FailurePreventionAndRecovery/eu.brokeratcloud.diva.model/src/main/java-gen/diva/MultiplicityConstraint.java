...
public interface MultiplicityConstraint extends Constraint {
	...
	/**
	 * Sets the value of the '{@link diva.MultiplicityConstraint#getAvailable
	...
	/**
	 * Sets the value of the '{@link diva.MultiplicityConstraint#getUpper
	...
	/**
	 * Sets the value of the '{@link diva.MultiplicityConstraint#getLower
	 ...
	 * 
	 * @model annotation=
	 *        "http://www.eclipse.org/emf/2002/GenModel body='return visitor.visitMultiplicityConstraint(this, context);'"
	 *        annotation=
