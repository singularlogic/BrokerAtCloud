...
/**
 * @generated NOT
 * @author Frank B�hr see
 *         http://www.daniweb.com/software-development/java/threads/177956/
 *         generating-all-possible-combinations-from-list-of-sublists
 */
public class ListCombinationGenerator<T> {
	 ...
	 * 
	 * //Set up some lists List<VariableValue> l1 = new
	 * ArrayList<VariableValue>(); BoolVariableValue bvv =
	 * DivaFactory.eINSTANCE.createBoolVariableValue(); bvv.setBool(true);
	 * BoolVariableValue bvv2 = DivaFactory.eINSTANCE.createBoolVariableValue();
	 * bvv2.setBool(false); l1.add(bvv); l1.add(bvv2);
	 * 
	 * List<VariableValue> l2 = new ArrayList<VariableValue>();
	 * BoolVariableValue bvv3 = DivaFactory.eINSTANCE.createBoolVariableValue();
	 * bvv.setBool(true); BoolVariableValue bvv4 =
	 * DivaFactory.eINSTANCE.createBoolVariableValue(); bvv2.setBool(false);
	 * l2.add(bvv3); l2.add(bvv4);
	 * 
	 * List<List<VariableValue>> ll = new ArrayList<List<VariableValue>>();
	 * ll.add(l1); ll.add(l2);
	 * 
	 * 
	 * ListCombinationGenerator<VariableValue> lcg = new
	 * ListCombinationGenerator(ll); long before = System.nanoTime();
	 * while(lcg.hasMoreCombinations()){ List<VariableValue> currentTupel =
	 * lcg.getNextCombination(); System.out.println("currentTupel: " +
	 * currentTupel+ "hasMoreCombinations: " + lcg.hasMoreCombinations); } long
	 * after = System.nanoTime(); System.out.println("Nanosconds: " +
	 * (after-before) ); }
	 */
