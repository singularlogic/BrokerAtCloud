...
public class SimulationOutputViewer extends DiVATableEditorPane implements Adapter {
	...
	public SimulationOutputViewer(DiVATableEditor editor, IWorkbenchPage page, IWorkbenchPart part) {
	...
	protected void initializeTableTreeViewer() {
		...
		treeViewerWithColumns.setContentProvider(new SimulationViewerContentProvider(editor.getAdaptedFactory()));
	...
	class SimulationViewerContentProvider extends AdapterFactoryContentProvider {
		...
		public Object[] getChildren(Object object) {
			...
			} else if (object instanceof ConfigVariant)
				return new Object[0];
			else if (object instanceof Priorities)
				return new Object[0];
	...
	static String[] PriorityValues = { "Lowest", "Very Low", "Low", "Medium", "High", "Very High", "Very High",
	...
	public class ScoreValueColumnLabelProvider extends ColumnLabelProvider {
		...
		public String getText(Object element) {
			...
			if (element instanceof ScoredElement) {
				...
				if (priority != null)
					return "" + PriorityValues[priority.getPriority()];
				else
					return NOEDIT_STRING;
			}
			return NOEDIT_STRING;
