...
public class DiVATextProvider extends EObjectImpl implements Visitor<String, String> {
	...
	public String visitMultiplicityConstraint(MultiplicityConstraint node, String context) {
	...
	public String visitConfigurationModel(ConfigurationModel node, String context) {
	...
	public String visitSuitableConfiguration(SuitableConfiguration node, String context) {
		// TODO Auto-generated method stub
