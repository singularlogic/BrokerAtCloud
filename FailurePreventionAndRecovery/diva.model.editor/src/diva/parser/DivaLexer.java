...
public class DivaLexer extends antlr.CharScanner implements DivaExpressionParserTokenTypes, TokenStream {
		...
		tryAgain: for (;;) {
			...
			try { // for char stream error handling
				try { // for lexical error handling
					...
					default:
						if ((LA(1) == 'c') && (LA(2) == 'r') && (LA(3) == 'e') && (LA(4) == 'a') && (LA(5) == 't')
								&& (LA(6) == 'e') && (true) && (true)) {
							mCREATE(true);
							theRetToken = _returnToken;
						} else if ((LA(1) == 'f') && (LA(2) == 'a') && (LA(3) == 'l') && (LA(4) == 's')
								&& (LA(5) == 'e') && (true) && (true) && (true)) {
							mFALSE(true);
							theRetToken = _returnToken;
						} else if ((LA(1) == '/') && (LA(2) == '*') && (LA(3) == '*')
								&& ((LA(4) >= '\u0000' && LA(4) <= '\u007f'))
								&& ((LA(5) >= '\u0000' && LA(5) <= '\u007f')) && (true) && (true) && (true)) {
							mCONTEXT_MULTI_LINE_COMMENT(true);
							theRetToken = _returnToken;
						} else if ((LA(1) == 't') && (LA(2) == 'r') && (LA(3) == 'u') && (LA(4) == 'e') && (true)
								&& (true) && (true) && (true)) {
							mTRUE(true);
							theRetToken = _returnToken;
							...
							theRetToken = _returnToken;
								...
								&& ((LA(4) >= '\u0000' && LA(4) <= '\u007f')) && (true) && (true) && (true) && (true)) {
							mMULTI_LINE_COMMENT(true);
							theRetToken = _returnToken;
						} else if ((LA(1) == 'n') && (LA(2) == 'o') && (LA(3) == 't') && (true) && (true) && (true)
								&& (true) && (true)) {
							mNOT(true);
							theRetToken = _returnToken;
						} else if ((LA(1) == 'a') && (LA(2) == 'n') && (LA(3) == 'd') && (true) && (true) && (true)
								&& (true) && (true)) {
							mAND(true);
							theRetToken = _returnToken;
						} else if ((LA(1) == 'o') && (LA(2) == 'r') && (true) && (true) && (true) && (true) && (true)
								&& (true)) {
							mOR(true);
							theRetToken = _returnToken;
						} else if ((LA(1) == ':') && (LA(2) == ':')) {
							mCOL_COL(true);
							theRetToken = _returnToken;
						} else if ((LA(1) == 'a') && (LA(2) == 's') && (true) && (true) && (true) && (true) && (true)
								&& (true)) {
							mAS(true);
							theRetToken = _returnToken;
						} else if ((LA(1) == '-') && (LA(2) == '>')) {
							...
							if ((LA(1) == '-') && (true) && (true) && (true) && (true) && (true) && (true) && (true)) {
							mMINUS(true);
							theRetToken = _returnToken;
						} else if ((LA(1) == ':') && (true)) {
							mCOLON(true);
	...
	public final void mLBRAK(boolean _createToken)
			throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype;
		Token _token = null;
		int _begin = text.length();
	...
	public final void mRBRAK(boolean _createToken)
			throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype;
		Token _token = null;
		int _begin = text.length();
	...
	public final void mCOL_COL(boolean _createToken)
			throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype;
		Token _token = null;
		int _begin = text.length();
	...
	public final void mSCOL(boolean _createToken)
			throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype;
		Token _token = null;
		int _begin = text.length();
	...
	public final void mCREATE(boolean _createToken)
			throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype;
		Token _token = null;
		int _begin = text.length();
	...
	protected final void mREAL_LITERAL(boolean _createToken)
			throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype;
		Token _token = null;
		int _begin = text.length();
	...
	public final void mSINGLE_LINE_COMMENT(boolean _createToken)
			throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype;
		Token _token = null;
		int _begin = text.length();
	...
	public final void mCONTEXT_MULTI_LINE_COMMENT(boolean _createToken)
			throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype;
		Token _token = null;
		int _begin = text.length();
	...
	public final void mEMPTY_LINE_COMMENT(boolean _createToken)
			throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype;
		Token _token = null;
		int _begin = text.length();
	...
	public final void mMULTI_LINE_COMMENT(boolean _createToken)
			throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype;
		Token _token = null;
		int _begin = text.length();
