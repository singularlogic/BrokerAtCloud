...
//XXX: 2014-10-15: TO-DELETE: ...see next...  >>>>  NO KEEP IT !!!!
...
//XXX:???: 2014-11-20 & 22: POORLY TESTED ADDITION!!!!
...
//XXX: 2014-11-18: Addition: UNTESTED!!!!
				Object refObj = retrieveObject( roUri, visited, pf.type /*2014-11-18*/ );
...
/*	protected static void _initXsd2javaBindings() {
	...
	protected static void _initRdfPersistenceSettings(String settingsFile) throws IOException {
		...
		p.load( RdfPersistenceManagerImpl4.class.getResourceAsStream(settingsFile) );
...
class PersistentClass {
	...
	public PersistentClass(Class c) throws UnsupportedEncodingException, ClassNotFoundException {
		...
		if (ann.registerWithRdfType()!=null && !ann.registerWithRdfType().trim().isEmpty()) {
			...
			RdfPersistenceManagerImpl4.registerTypeWithRdfClass(this, this.registerWithRdfType);
		}
