...
//import eu.brokeratcloud.common.Consumer;
...
/*	public void addPreference(ConsumerPreference p) { preferences.put(p.getId(), p); }
	public void setPreference(ConsumerPreference p) { preferences.put(p.getId(), p); }
	public void removePreference(ConsumerPreference p) { preferences.remove(p.getId()); }
	public void removePreference(String pId) { preferences.remove(pId); }*/
