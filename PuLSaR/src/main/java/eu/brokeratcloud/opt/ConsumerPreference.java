...
public class ConsumerPreference extends BrokerObject {
	@XmlAttribute
	//@RdfPredicate(uri="http://www.linked-usdl.org/ns/usdl-pref#hasPrefVariable", update="no")
	//protected PreferenceVariable criterion;
...
//	public PreferenceVariable getCriterion() { return criterion; }
//	public void setCriterion(PreferenceVariable pv) { criterion = pv; }
