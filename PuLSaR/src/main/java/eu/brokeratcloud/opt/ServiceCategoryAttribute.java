...
/*@RdfSubject(
	uri="http://www.brokeratcloud.eu/v1/opt/SERVICE-CATEGORY-ATTRIBUTE"
	//, rdfType="http://www.linked-usdl.org/ns/usdl-pref#FunctionalServiceCategoryToOptimizationAttributeAssociation"
)*/
public class ServiceCategoryAttribute extends BrokerObject {
	...
	//protected OptimisationAttribute attribute;
