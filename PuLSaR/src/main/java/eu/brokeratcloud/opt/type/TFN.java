...
public class TFN {
	...
	public void setLowerBound(double l) { this.lowerBound = l; _updateState(); }
	public double getMeanValue() { return meanValue; }
	public void setMeanValue(double m) { this.meanValue = m; _updateState(); }
	public double getUpperBound() { return upperBound; }
	public void setUpperBound(double u) { this.upperBound = u; _updateState(); }
