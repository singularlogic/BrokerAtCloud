...
public class AuxiliaryService extends AbstractManagementService {
	...
	protected ServiceDescription _getServiceDescription(String srvUri, String smUri, String slpUri, String bpi, String bpsmc, SparqlServiceClient client) {
		try {
			...
			sd.setId( smUri );			// service id is not really used anywhere else but internally in RecommendationManager. No need it assign a new service id
			...
			String queryStrSLP = 
				...
				"				BIND ( 'BOOLEAN' as ?typ ) . \n"+
				"			} \n"+
// For an unknown reason, JENA query parser throws an exception when encounters "NOT" (in the following part of the query)\n"+
// Workaround: we comment out this part but as a result it will return an empty ?typ variable for 'unordered set' attributes\n"+
//             Therefore in the code after query we handle empty ?typ as UNORDERED_SET\n"+
/*				"			UNION \n"+
				"			{ \n"+
				"				NOT EXISTS { \n"+
				"					{ ?ind <http://purl.org/goodrelations/v1#greater> ?ind1 } \n"+
				"					UNION \n"+
				"					{ ?ind <http://purl.org/goodrelations/v1#lesser> ?ind1 } . \n"+
				"				} . \n"+
				"				BIND ( 'UNORDERED_SET' as ?typ ) \n"+
				"			} . \n"+
*/
				"		} \n"+
				"	} . \n"+
...
//				"	OPTIONAL { ?defVal <http://www.linked-usdl.org/ns/usdl-core/cloud-broker#hasMinSupport> ?minSupVal } . \n"+
				...
				"	} . \n"+
//				"	OPTIONAL { ?defVal <http://www.linked-usdl.org/ns/usdl-core/cloud-broker#hasMaxSupport> ?maxSupVal } . \n"+
				"	OPTIONAL { \n"+
				...
				"	} . \n"+
//				"	OPTIONAL { ?defVal <http://www.linked-usdl.org/ns/usdl-core/cloud-broker#hasMinKernel> ?minKernVal } . \n"+
				"	OPTIONAL { \n"+
				...
				"	} . \n"+
//				"	OPTIONAL { ?defVal <http://www.linked-usdl.org/ns/usdl-core/cloud-broker#hasMaxKernel> ?maxKernVal } . \n"+
				"	OPTIONAL { \n"+
				...
				"	} . \n"+
//				"	OPTIONAL { ?defVal <http://www.linked-usdl.org/ns/usdl-core/cloud-broker#hasMaxMembershipValue> ?meanVal } . \n"+
				"	OPTIONAL { \n"+
...
/*				"SELECT DISTINCT ?allowedValues ?defVal ?defValLabel ?uom ?minVal ?maxVal ?minSupVal ?maxSupVal ?minKernVal ?maxKernVal \n"+
				"WHERE { \n"+
				"	# BROKER POLICY \n"+
				"	BIND ( <" + slpUri + "> as ?slp ). \n"+
				"	?bpi ?hasSLP ?slp . \n"+
...
//					if (!minVal.isEmpty() || !maxVal.isEmpty() /*|| !uom.isEmpty()*/) {
//						attrs.put(apvUri, "["+minVal+"-"+maxVal+"]");	// +" "+uom);
//					} else
//					if (!minSupVal.isEmpty() || !minKernVal.isEmpty() || !maxSupVal.isEmpty() || !maxKernVal.isEmpty()) {
//						attrs.put(apvUri, "["+minSupVal+";"+minKernVal+";"+maxKernVal+";"+maxSupVal+"]");	// +" "+uom);
//					} else {
//						attrs.put(apvUri, label.isEmpty() ? valUri : label);
//					}
...
//					"	OPTIONAL { ?val <http://purl.org/goodrelations/v1#hasValue> ?oneVal } . \n"+
					"	OPTIONAL { \n"+
					"		?rel1 <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> * <http://purl.org/goodrelations/v1#hasValue> . \n"+
					"		?val ?rel1 ?oneVal \n"+
					"	} . \n"+
//					"	OPTIONAL { ?val <http://purl.org/goodrelations/v1#hasMinValue> ?minVal } . \n"+
					"	OPTIONAL { \n"+
					"		?rel2 <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> * <http://purl.org/goodrelations/v1#hasMinValue> . \n"+
					"		?val ?rel2 ?minVal \n"+
					"	} . \n"+
//					"	OPTIONAL { ?val <http://purl.org/goodrelations/v1#hasMaxValue> ?maxVal } . \n"+
					"	OPTIONAL { \n"+
					"		?rel3 <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> * <http://purl.org/goodrelations/v1#hasMaxValue> . \n"+
					"		?val ?rel3 ?maxVal \n"+
					"	} . \n"+
//					"	OPTIONAL { ?val <http://www.linked-usdl.org/ns/usdl-core/cloud-broker#hasMinSupport> ?minSupVal } . \n"+
					"	OPTIONAL { \n"+
					"		?rel4 <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> * <http://purl.org/goodrelations/v1#hasMinSupport> . \n"+
					"		?val ?rel4 ?minSupVal \n"+
					"	} . \n"+
//					"	OPTIONAL { ?val <http://www.linked-usdl.org/ns/usdl-core/cloud-broker#hasMaxSupport> ?maxSupVal } . \n"+
					"	OPTIONAL { \n"+
					"		?rel5 <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> * <http://purl.org/goodrelations/v1#hasMaxSupport> . \n"+
					"		?val ?rel5 ?maxSupVal \n"+
					"	} . \n"+
//					"	OPTIONAL { ?val <http://www.linked-usdl.org/ns/usdl-core/cloud-broker#hasMinKernel> ?minKernVal } . \n"+
					"	OPTIONAL { \n"+
					"		?rel6 <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> * <http://purl.org/goodrelations/v1#hasMinKernel> . \n"+
					"		?val ?rel6 ?minKernVal \n"+
					"	} . \n"+
//					"	OPTIONAL { ?val <http://www.linked-usdl.org/ns/usdl-core/cloud-broker#hasMaxKernel> ?maxKernVal } . \n"+
					"	OPTIONAL { \n"+
					"		?rel7 <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> * <http://purl.org/goodrelations/v1#hasMaxKernel> . \n"+
					"		?val ?rel7 ?maxKernVal \n"+
					"	} . \n"+
//					"	OPTIONAL { ?val <http://www.linked-usdl.org/ns/usdl-core/cloud-broker#hasMaxMembershipValue> ?meanVal } . \n"+
					"	OPTIONAL { \n"+
					"		?rel8 <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> * <http://purl.org/goodrelations/v1#hasMaxMembershipValue> . \n"+
					"		?val ?rel8 ?meanVal \n"+
					"	} . \n"+
					"} \n"+
					"ORDER BY ?allowedValues \n";
