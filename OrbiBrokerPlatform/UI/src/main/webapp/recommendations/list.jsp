...
<html>
    <head>
        <title>Recommendations &mdash; ORBI</title>
    ...
    <body>
        ...
        <main>
            <div class="container">
                <div class="col-md-3">
                    <nav>
                        <ul>
                            ...
                            <li><a class="active" href="/orbibroker/recommendations/list">Recommendations</a></li>
                ...
                <div class="col-md-9">
                    ...
                    <h2>Recommendations<p class="lead"><span class="glyphicon glyphicon-asterisk"></span> Get recommendations</p></h2>
        ...
        <script>
                            $(document).ready(function () {
                                linkLocation = "http://pulsar.euprojects.net:3353/forms/consumer/recoms.jsp?standalone=no";
                                console.log("1")
                                $("#autoLoginBTN").click();
                                console.log("2")
                            });
