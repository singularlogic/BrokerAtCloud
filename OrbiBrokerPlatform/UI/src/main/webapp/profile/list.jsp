...
<html>
    <head>
        <title>Pulsar Notifications &mdash; ORBI</title>
    ...
    <body>
        ...
        <main>
            <div class="container">
                <div class="col-md-3">
                    <nav>
                        <ul>
                            ...
                            <li><a class="active" href="/orbibroker/profile/list">Profile</a></li>
                ...
                <div class="col-md-9">
                    ...
                    <h2>Profile<p class="lead"><span class="glyphicon glyphicon-asterisk"></span> Configure profile</p></h2>
        ...
        <script>
                            $(document).ready(function () {
                                linkLocation = "http://pulsar.euprojects.net:3353/forms/consumer/pref-profile-mgnt.jsp?standalone=no";
                                console.log("1")
                                $("#autoLoginBTN").click();
                                console.log("2")
                            });
