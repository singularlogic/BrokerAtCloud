                                    ...
                                    <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                        ...
                                        <tbody>
                                            <c:forEach items="${consumers}" var="consumers">
                                                <tr>
                                                    <td><c:out value="${consumers.username}"></c:out></td>
                                                    <td><c:out value="${consumers.name}"></c:out></td>
                                                    <td><c:out value="${consumers.surname}"></c:out></td>
                                                    <td><c:out value="${consumers.email}"></c:out></td>
                                                    <td><c:out value="${fn:substring(consumers.date_created, 0, 19)}"></c:out></td>
                                                        <td><!--                                                                <a title="Edit" data-rel="tooltip" class="btn btn-xs btn-info" href="#">
                                                                    <i class="fa fa-edit"></i>  
                                                                </a>-->
                                                            <a title="Delete" data-rel="tooltip" class="btn btn-xs btn-danger" href="consumers?remove=<c:out value="${consumers.id}"></c:out>">
