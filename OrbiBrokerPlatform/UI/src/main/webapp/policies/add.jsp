        ...
        <main>
            <div class="container">
                ...
                <div class="col-md-9">
                    ...
                    <h2>Broker Policies<p class="lead"><span class="glyphicon glyphicon-asterisk"></span> Broker Policy Add</p></h2>
                        ...
                        <div class="row">
                            <div id="serviceLoadArea" class="collapse in">
                                <div class="droptarget" ondrop="loadBP(event)" ondragover="allowDrop(event)">
                                    <p id="bp">Drop your broker policy (.TTL) here<br/>or use the form below to create your policy</p>
                                </div>
                            </div>
                            <div id="serviceEditArea" class="collapse in">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class='panel-body'>
                                        <form>
                                            ...
                                            <div class="form-group">
                                                <label>Is successor of (URI to the predecessor broker policy, optional)</label>
                                                <input class="form-control" type="text" id="successor_of_bp" value="">
                                            </div>
                                            <div class="form-group">
                                                <label>Service onboarding deprecation (for predecessor broker policy, optional)</label>
                                                <input class="form-control" type="text" id="onboarding_deprecated_from" value="YYYY-MM-DD">
                                            </div>
                                            <div class="form-group">
                                                <label>Service recommendation deprecation (for predecessor broker policy, optional)</label>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="bc-buttongroup" style="margin:20px">
                                        <button onclick="submitBrokerPolicyForm()" class="btn btn-default btn-success">Save</button>
                                        &nbsp;&nbsp;&nbsp;
