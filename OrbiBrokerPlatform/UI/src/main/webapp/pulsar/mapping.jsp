...
<html>
    <head>
        <title>Attr. Mapping &mdash; ORBI</title>
    ...
    <body>
        ...
        <main>
            <div class="container">
                <div class="col-md-3">
                    <nav>
                        <ul>
                            ...
                            <li><a class="active" href="/orbibroker/pulsar/mapping">Attr. Mapping</a></li>
                ...
                <div class="col-md-9">
                    ...
                    <h2>Attr. Mapping<p class="lead"><span class="glyphicon glyphicon-asterisk"></span> Service Attribute Mapping to Service Classifications
</p></h2>
        ...
        <script>
                            $(document).ready(function () {
                                linkLocation = "http://pulsar.euprojects.net:3353/forms/admin/attribute-mapping.jsp?standalone=no";
                                console.log("1")
                                $("#autoLoginBTN").click();
                                console.log("2")
                            });
