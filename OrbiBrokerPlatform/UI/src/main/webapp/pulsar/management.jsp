...
<html>
    <head>
        <title>Serv. Attr. Mgmt &mdash; ORBI</title>
    ...
    <body>
        ...
        <main>
            <div class="container">
                <div class="col-md-3">
                    <nav>
                        <ul>
                            ...
                            <li><a class="active" href="/orbibroker/pulsar/management">Serv. Attr. Mgmt</a></li>
                ...
                <div class="col-md-9">
                    ...
                    <h2>Serv. Attr. Mgmt<p class="lead"><span class="glyphicon glyphicon-asterisk"></span> Service attribute hierarchy management</p></h2>
        ...
        <script>
                            $(document).ready(function () {
                                linkLocation = "http://pulsar.euprojects.net:3353/forms/admin/attribute-mgnt.jsp?standalone=no";
                                console.log("1")
                                $("#autoLoginBTN").click();
                                console.log("2")
                            });
