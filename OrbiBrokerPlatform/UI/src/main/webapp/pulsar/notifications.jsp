...
<html>
    <head>
        <title>Profile &mdash; ORBI</title>
    ...
    <body>
                ...
                <div class="col-md-3">
                    <nav>
                        <ul>
                            ...
                            <li><a class="active" href="/orbibroker/pulsar/notifications">Notifications</a></li>
                        </ul>
                    </nav>
                </div>
        ...
        <script>
                            $(document).ready(function () {
                                linkLocation = "http://pulsar.euprojects.net:3353/forms/provider/notifications.jsp";
                                console.log("1")
                                $("#autoLoginBTN").click();
                                console.log("2")
                            });
