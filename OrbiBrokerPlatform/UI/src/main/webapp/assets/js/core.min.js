...
jQuery(document).ready(function (e) {
    ...
    if (e(".linechart").length)
        if (retina()) {
            e(".linechart").sparkline("html", {width: "130", height: "60", lineColor: "#ffffff", fillColor: !1, spotColor: !1, maxSpotColor: !1, minSpotColor: !1, spotRadius: 2, lineWidth: 2});
            if (jQuery.browser.mozilla) {
                e(".linechart").css("MozTransform", "scale(0.5,0.5)").css("height", "30px;");
                e(".linechart").css("height", "30px;").css("margin", "-15px 15px -15px -15px")
            } else
                e(".linechart").css("zoom", .5)
        } else
            e(".linechart").sparkline("html", {width: "65", height: "30", lineColor: "#ffffff", fillColor: !1, spotColor: !1, maxSpotColor: !1, minSpotColor: !1, spotRadius: 2, lineWidth: 1});
...
jQuery(document).ready(function () {
    $(".skill-bar") && $(".meter > span").each(function () {
        ...
        $(this).width(0).animate({width: e + "%", countNum: e + 1}, {duration: 3e3, easing: "linear", step: function () {
