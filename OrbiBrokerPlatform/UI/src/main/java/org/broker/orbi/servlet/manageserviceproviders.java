 ...
 * @author ermis
 */
public class manageserviceproviders extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<SPOffer> spoffers = Util.getAllSPOffers();
        request.setAttribute("spoffers", spoffers);
        response.setContentType("text/html;charset=UTF-8");
        request.setAttribute("username", username);
        request.getRequestDispatcher("ManageServiceProviders.jsp").forward(request, response);
    }
