 ...
 */
public class retrievePolicyVariables extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<PolicyVariable> variables =  Util.getAllPolicyProfileVariablesDependOnPolicy(policyID,"");  //Util.getPolicyAllProfilesVariables(Integer.parseInt(policyID));

        String variablesSTR = "";
        
        for (PolicyVariable tempVar : variables) {
            variablesSTR += "{\"id\":\"" + tempVar.getId() + "\",\"name\":\"" + tempVar.getName() + "\"},";
        }
